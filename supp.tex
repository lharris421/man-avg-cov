...
\begin{table}[hbtp]
  ...
  \caption{\label{tab:E1} Coverage rates by magnitude of $\beta$ for RL-P using both the lasso and the MCP penalty applied to the Sparse 1 scenario described in Section~\ref{Sec:distribution}. The nominal coverage rate is 80\%. }
\end{table}
