...
The relaxed lasso posterior intervals are available through the \texttt{pipe\_ncvreg} \pb{confint(fit)} function in the current version of the R package \texttt{ncvreg} (3.16.0).
...
\begin{figure}[htb!]
  \begin{center}
    \includegraphics[width=0.8\linewidth]{figure9}
