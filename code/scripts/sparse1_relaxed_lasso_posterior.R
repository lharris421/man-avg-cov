...
if (interactive()) {
  saveRDS(bind_rows(res), glue("rds/{iterations}/sparse1_relaxed_lasso_posterior.rds"))
} else {
  saveRDS(bind_rows(res), glue("code/rds/{iterations}/sparse1_relaxed_lasso_posterior.rds"))
}
