...
if (interactive()) {
  res <- readRDS(glue("rds/{iterations}/original/{opt$distribution}_{opt$corr}_{opt$rho}_{opt$n}_{opt$p}_{opt$sigma}_{opt$snr}_{method_name}.rds"))
} else {
  res <- readRDS(glue("code/rds/{iterations}/original/{opt$distribution}_{opt$corr}_{opt$rho}_{opt$n}_{opt$p}_{opt$sigma}_{opt$snr}_{method_name}.rds"))
}
...
if (interactive()) {
  saveRDS(res, glue("rds/{iterations}/gam/{opt$distribution}_{opt$corr}_{opt$rho}_{opt$n}_{opt$p}_{opt$sigma}_{opt$snr}_{method_name}.rds"))
} else {
  saveRDS(res, glue("code/rds/{iterations}/gam/{opt$distribution}_{opt$corr}_{opt$rho}_{opt$n}_{opt$p}_{opt$sigma}_{opt$snr}_{method_name}.rds"))
}
