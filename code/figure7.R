if (interactive()) {
  ...
  results_rlp <- readRDS("rds/laplace_relaxed_lasso_posterior.rds")
  results_si  <- readRDS("rds/laplace_selective_inference.rds")
  results_dl  <- readRDS("rds/laplace_desparsified_lasso.rds")
} else {
  source("code/scripts/setup.R")
  results_rlp <- readRDS("code/rds/laplace_relaxed_lasso_posterior.rds")
  results_si  <- readRDS("code/rds/laplace_selective_inference.rds")
  results_dl  <- readRDS("code/rds/laplace_desparsified_lasso.rds")
}
